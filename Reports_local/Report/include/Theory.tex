...
\vspace{2pt}
\begin{itemize}
\item\text{\textbf{Prove} $(\mathbf{g},\mathbf{h},P_v,c,u,\mathbf{q},\mathbf{s})\xrightarrow[]{}\textit{proof}_{IP}=(\mathbf{g},\mathbf{h},P_v',u^y,\mathbf{s},\mathbf{q},\mathbf{l},\mathbf{r})$}\\
...
\end{itemize}
\item\text{\textbf{Verify} $(g,h,C,\textit{proof}_{IP})\xrightarrow[]{}\{0,1\}$}\\
